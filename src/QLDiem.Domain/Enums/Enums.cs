...
public enum LoaiDanhGia
{
    ...
    /// <summary>Chỉ đánh giá bằng nhận xét: Đạt / Chưa đạt (GDTC, Âm nhạc, Mĩ thuật, HĐTN-HN, NDGDĐP).</summary>
    NhanXet = 2
}

/// <summary>Đầu điểm theo Thông tư 22/2021/TT-BGDĐT, Điều 6 và Điều 7.</summary>
