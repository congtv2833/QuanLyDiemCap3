...
public class QLDiemDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        // Rút gọn tên bảng Identity cho dễ đọc khi xem trong SSMS.
        b.Entity<ApplicationUser>().ToTable("TaiKhoan");
        b.Entity<Microsoft.AspNetCore.Identity.IdentityRole>().ToTable("VaiTro");
        b.Entity<Microsoft.AspNetCore.Identity.IdentityUserRole<string>>().ToTable("TaiKhoan_VaiTro");
        b.Entity<Microsoft.AspNetCore.Identity.IdentityUserClaim<string>>().ToTable("TaiKhoan_Claim");
        b.Entity<Microsoft.AspNetCore.Identity.IdentityUserLogin<string>>().ToTable("TaiKhoan_Login");
        b.Entity<Microsoft.AspNetCore.Identity.IdentityUserToken<string>>().ToTable("TaiKhoan_Token");
        b.Entity<Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>>().ToTable("VaiTro_Claim");
